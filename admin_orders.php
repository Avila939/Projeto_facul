...
if(isset($_POST['update_order'])){
   ...
   $message[] = 'O status do pagamento foi atualizado!';
...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> preço totoal: <span>$<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
         ...
         <form action="" method="post">
            ...
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('Excluir este pedido?');" class="delete-btn">Remover</a>
         </form>
      </div>
      <?php
         }
