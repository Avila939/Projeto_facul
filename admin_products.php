...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="add produto" name="add_product" class="btn">
   </form>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">Ainda não foram adicionados produtos!</p>';
      }
      ?>
   </div>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="update_name" value="<?php echo $fetch_update['name']; ?>" class="box" required placeholder="Digitar o nome...">
      <input type="number" name="update_price" value="<?php echo $fetch_update['price']; ?>" min="0" class="box" required placeholder="digitar o preço...">
